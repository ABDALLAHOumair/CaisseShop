      ...
      <div class="form-layout">
        <div class="form-left">
          ...
          <div class="form-group">
            ...
            <input class="form-input" type="text" id="ref-input" placeholder="">
          </div>
          <div class="form-row">
            <div class="form-group">
        ...
        <div class="form-right">
          <div class="img-box img-box--empty" id="img-box">
            <img id="preview-img" src="" alt="" style="display:none">
            <svg class="img-placeholder-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.2">
