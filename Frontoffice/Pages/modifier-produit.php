        ...
        <form action="submit_modification.php" method="post" class="form-layout">
          <div class="form-left">
            <div class="form-group">
              ...
              <input class="form-input" type="text" id="productName" name="nom_produit" value="<?php echo $ProduitTarget[0]['Nom_produit']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-input" type="text" id="barcodeValue" name="code_barre" value="<?php echo $ProduitTarget[0]['Code_barre']; ?>">
            </div>
            <div class="form-row">
              <div class="form-group">
